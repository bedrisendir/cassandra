...
package org.apache.cassandra.db.commitlog.capi.util;
...
public class SimpleCachedCheckSummedBufferPool
{
    ...
    public SimpleCachedCheckSummedBufferPool(int maxBufferPoolSize, int bufferSize)
    {
        this.maxBufferPoolSize = maxBufferPoolSize;
        this.bufferSize = bufferSize;
    }

    public CheckSummedBuffer createBuffer(BufferType bufferType)
    {
    ...
    public void releaseBuffer(CheckSummedBuffer buf)
    {
